...
<head>
    <title>Fishtatic - Pencarian</title>
    <!-- for-mobile-apps -->
        ...
        <div class="container">
            <div class="w3_footer_grids">
                <div class="col-md-4 w3_footer_grid">
                    ...
                    <ul class="address">
                        <li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Fishtatic Store, DKI
                            Jakarta.
                        </li>
    ...
    <div class="footer-botm">
        <div class="container">
            <div class="w3layouts-foot">
                <ul>
                    <li><a href="https://www.instagram.com/Fishtatic_olshop/" class="w3_agile_instagram"><i
