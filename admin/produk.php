		...
		if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
		  if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into produk (idkategori, namaproduk, gambar, deskripsi)
			  values('$idkategori','$namaproduk','$pathdb','$deskripsi')";
...
<head>
    ...
    <title>Kelola Ikan - Fishtatic</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li><a href="../"><span>Kembali ke Halaman User</span></a></li>
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="produk.php">Daftar Ikan</a></li>
                                </ul>
                            </li>
                            <li><a href="customer.php"><span>Kelola User</span></a></li>
                            ...
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal"
                                        class="btn btn-info col-md-2">Tambah Ikan</button>
                                </div>
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo $no++ ?></td>
                                                <td><img src="<?php echo $p['gambar'] ?>" width="200px"
                                                        height="200px" /></td>
                                                        ...
                                                        <form method="post" enctype="multipart/form-data">
                                                            <div class="modal-body">
                                                                ...
                                                                <input type="text" name="namaproduk"
                                                                    value="<?=$p['namaproduk'];?>" class="form-control"
                                                                    required>
                                                                <br>
                                                                Deskripsi
                                                                <input type="text" name="deskripsi"
                                                                    value="<?=$p['deskripsi'];?>" class="form-control"
                                                                    required>
                                                                <br>
                                                                Kategori
