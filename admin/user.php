...
<head>
    ...
    <title>Kelola Staff - Fishtatic</title>
                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="produk.php">Daftar Ikan</a></li>
                ...
                <div class="modal-body">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <input name="namalengkap" type="text" class="form-control" placeholder="Username" required
                                autofocus>
                        </div>
                        <div class="form-group">
                            <label>Email</label>
