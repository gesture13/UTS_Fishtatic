...
<head>
    <title>Fishtatic - Kategori</title>
    <!-- for-mobile-apps -->
    ...
    <div class="breadcrumbs">
        <div class="container">
            <ol class="breadcrumb breadcrumb1 animated wow slideInLeft" data-wow-delay=".5s">
                ...
                <li class="active">Habitat Ikan</li>
            </ol>
        </div>
    </div>
    <!-- //breadcrumbs -->
                                        ...
                                        <div class="snipcart-item block">
                                            <div class="snipcart-thumb">
                                                <a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><img
                                                        src="ynk5/<?php echo $p['gambar']?>" width="100%" height="150px"
                                                        object-fit="cover" object-position="center"></a>
                                                <p><?php echo $p['namaproduk'] ?></p>
                                            </div>
                                            <div class="snipcart-details top_brand_home_details">
                                                <fieldset>
                                                    <a href="product.php?idproduk=<?php echo $p['idproduk'] ?>"><input
                                                            type="submit" class="button" value="Detail Ikan" /></a>
                                                </fieldset>
                                            </div>
                                        </div>
                                    </figure>
